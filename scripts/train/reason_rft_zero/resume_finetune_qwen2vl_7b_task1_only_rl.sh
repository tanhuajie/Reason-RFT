...
export WANDB_RUN_NAME=resume_finetune_qwen2vl_7b_task1_only_rl-$(date +%Y-%m-%d-%H-%M-%S)
wandb login $WANDB_API_KEY

# Dataset
export TASK_NAME=clevr-math
export DATASET_NAME=/path/to/your/dataset/clevr-math-train.json
export IMAGE_PATH=/path/to/your/train_images/
export MODEL_NAME_OR_PATH=/path/to/your/pretrain_model/Qwen2-VL-7B-Instruct
